                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div style="width:100%;">
                                                        <div class="h3-search">
                                                                    Booking Date: '.substr($appdate,0,30).'<br>
                                                                    Reference Number: edoc.dpsh-000-'.$id.'
                                                                </div>
                                                                <div class="h1-search">
                                                                ...
                                                                <br>
                                                                <a href="?action=drop&id='.$id.'&title='.$title.'&doc='.$docname.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Booking</font></button></a>
                                                        </div>
